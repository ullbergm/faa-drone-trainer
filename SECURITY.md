...
- Preferred: [GitHub private vulnerability reporting](https://github.com/ullbergm/faa-drone-test-training/security/advisories/new)
...
Each release carries `faa-drone-test-training-VERSION.tar.gz`, a copy of exactly the
...
```
gh attestation verify faa-drone-test-training-VERSION.tar.gz \
  --repo ullbergm/faa-drone-test-training
```

Add `--bundle faa-drone-test-training-VERSION.tar.gz.intoto.jsonl` to verify offline
...
- Content accuracy of the study questions (use the
  [question correction template](https://github.com/ullbergm/faa-drone-test-training/issues/new?template=question-correction.yml)).
